...
import (
	...
	"github.com/samimriaz/kubernetes-health-rollout-controller/controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4b7d0e0b.healthrollout.io",
	...
	if err := (&controller.HealthGatedRolloutReconciler{
		Client:         mgr.GetClient(),
		Scheme:         mgr.GetScheme(),
		SignalProvider: controller.NewPrometheusSignalProvider(),
		Recorder:       mgr.GetEventRecorderFor("healthgatedrollout-controller"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "healthgatedrollout")
		os.Exit(1)
	}
